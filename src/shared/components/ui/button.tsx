...
const buttonVariants = cva(
	'ring-offset-background group inline-flex cursor-pointer items-center justify-center text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-60 has-data-[arrow=true]:justify-between [&_svg]:shrink-0',
	{
		variants: {
			variant: {
				primary:
			...
			mode: {
				default: 'focus-visible:ring-ring focus-visible:ring-2 focus-visible:ring-offset-2',
